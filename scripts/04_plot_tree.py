...
fig = plt.figure(figsize=(12,40), dpi=300) # figsize=(12,40) => 12 de largura por 40 de altura, , dpi=300 => resolução da imagem em pontos por polegada (ideal)
...
axes.set_xlabel("Ditância Genética (substituições/sítio)", fontsize=10)
...
print(f"Arvore gerada e salva com sucesso em {output}")
